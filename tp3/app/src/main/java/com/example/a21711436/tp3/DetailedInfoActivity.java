...
public class DetailedInfoActivity extends Activity {
    ...
    public void validate(View v) {
        ...
        Profile profile = new Profile(this.name, this.age, this.email, this.phone, getRadioGroupDiplomaValue(), text_moreInfo.getText().toString(), getCheckedProgrammingLanguages(), switch_newsletter.isChecked());
        profile.saveToDisk();
